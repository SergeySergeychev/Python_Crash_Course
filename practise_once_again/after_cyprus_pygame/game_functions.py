...
def update_aliens(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    and then update the position of aliens in the fleet.
    Respond if ship has been hit by alien.
    """
    ...
    if pygame.sprite.spritecollideany(ship, aliens):
        ship_hit(ai_settings, screen, stats, sb, ship, aliens, bullets)
    # Loook for aliens hitting the bottom of the screen.
    check_aliens_bottom(ai_settings, screen, stats, sb, ship, aliens,
        bullets)

def check_high_score(stats, sb):
    """Check to see if there's a mew high score."""
...
def read_high_score():
    with open('high_score.txt') as r_f:
        high_score = r_f.readline()
        return(int(high_score))


def write_high_score(stats):
    with open('high_score.txt', 'w') as w_f:
        w_f.write(str(stats.high_score))
